...
module.exports = {
  ...
  plugins: ["@typescript-eslint", "prettier", "node", "import", "json"],
  settings: {
    "import/resolver": {
  ...
  rules: {
    ...
    "@typescript-eslint/no-unused-vars": [
      "error",
      {
        argsIgnorePattern: "^_|req|res|next|args|ctx|global__",
        varsIgnorePattern: "^_|req|res|next|args|ctx|global__",
      },
    ],
    // END
